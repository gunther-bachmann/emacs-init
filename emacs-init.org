...
*** org sidebar
    ...
    #+begin_src emacs-lisp
      (use-package org-sidebar
        ...
        :config
        (setq org-ql-sidebar-buffer-setup-hook
              '((lambda ()
...
** slack
 #+BEGIN_SRC emacs-lisp
   ...
   (use-package slack
     ...
     :commands (gb/slack-start gb/slack-stop)
     ...
     (setq slack-buffer-create-on-notify nil) ;; might be necessary to set to true, to allow buffer tracking!
     :config
     ...
     (defun gb/slack-stop ()
       (interactive)
       (ignore-errors
         (when (-contains? kill-emacs-hook #'gb/slack-stop)
           (remove-hook 'kill-emacs-hook #'gb/slack-stop)))
     ...
     (defun gb/slack-start ()
       ...
       (unless (-contains? kill-emacs-hook #'gb/slack-stop)
         (add-hook 'kill-emacs-hook #'gb/slack-stop t)))
     ...
     (setq gb/slack-status-away-list '("mampf :fork_and_knife:" "home :house_with_garden:"))
     ...
     (defun gb/slack-modeline-status-update ()
       (setq gb/slack-modeline--status (s-concat " " (emojify-string (slack-user-status (oref (slack-team-select) self-id) (slack-team-select)))))
    ...
    #+BEGIN_SRC emacs-lisp
      (when gb/use-exwm
        (use-package exwm
          ...
          :config
          (setq exwm-floating-border-color "purple4")
...
* EVAL google-translate
  #+begin_src emacs-lisp
    (use-package google-translate
      :ensure t
      :config
      (bind-key "H-h l" #'google-translate-at-point)
      (bind-key "H-h h" #'gb/translate-at-point-eng-ger)
