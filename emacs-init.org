          ...
          (progn
            ...
            (defun gb/pdf-view-scroll-up-or-next-page (orig-func &rest args)
              ...
              (let ((vscroll-before (window-vscroll)))
                ...
                (when (eq vscroll-before (window-vscroll)) ;; if scroll position before is exactly the same as after, jump to next page
   ...
   (use-package alert
     ...
     (setq alert-user-configuration
           '((((:category . "slack")) ignore nil)
             (((:title . "\\(nord\\|Slackbot\\|generali\\|nintendo\\|offizielles\\|mpdm-\\)")(:category . "slack")) gb-alert-style nil)))
...
* vue (via lsp)
  ...
  #+begin_src emacs-lisp :tangle no
    (when (and (fboundp 'eglot) (fboundp 'web-mode))
