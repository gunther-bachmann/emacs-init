...
#+END_SRC
  ...
  (when gb/use-exwm
    ...
    (use-package exwm-config
      ...
      (exwm-input-set-key (kbd "s-<left>") (lambda () (interactive) (gb/wrap-in-exwm-reset #'windmove-left)))
      (exwm-input-set-key (kbd "s-<right>") (lambda () (interactive) (gb/wrap-in-exwm-reset #'windmove-right)))
