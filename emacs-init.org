...
*** accounts (user specific stuff)
    #+BEGIN_SRC emacs-lisp
      (if (file-exists-p "~/.emacs.d/accounts/mail-accounts.el")
...
*** org agenda
  #+BEGIN_SRC emacs-lisp
    (req-package org-agenda
      :require org helm agenda-accounts
      :config
      (progn
        ...
        (bind-key "i" #'gb/org-agenda-diary-entry org-agenda-keymap)
...
*** accounts for calendar sync
    #+BEGIN_SRC emacs-lisp
      (if (file-exists-p "~/.emacs.d/accounts/calendar-accounts.el")
