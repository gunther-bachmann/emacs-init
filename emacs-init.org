  ...
  #+begin_src emacs-lisp
    (when gb/profile--org-roam
      (use-package notdeft
        ...
        (notdeft-xapian-program "/home/pe/repo/emacs/notdeft/xapian/notdeft-xapian")
...
* org roam
  ...
  #+begin_src emacs-lisp
    ...
    GB: updated to no longer depend on org-roam-mode but check via org-roam-stack"
          ...
          ;; (use-package nroam
          ;;   ;; :load-path "/home/pe/repo/emacs/nroam/"
          ;;   :ensure t
          ;;   :config
  ...
  - en/disable touchpad depending on currently visited buffer
    #+begin_src emacs-lisp
      (if (not (executable-find "set-touchpad"))
        ...
        (add-to-list 'gb/execute-on-soft-reset #'gb/touchpad-on)
