    ...
    #+begin_src emacs-lisp
      ...
      (setq left-global-mode-string
            (list '((:eval
                  ...
                  '(:eval (or (propertize-base-name (get-project-relative-buffer-filename))
          ...
          (add-hook 'exwm-init-hook
                    (lambda ()
                      ...
                      (setq global-mode-string
                            (append '("" (:eval (when (gb/modeline-line-selected-window-active-p) (list emms-mode-line-string emms-playing-time-string " ")))
