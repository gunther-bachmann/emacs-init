    ...
    (use-package org
      ...
      (progn
        ...
        (setq org-file-apps (append '(("\\.sid\\'" . "sidplayfp '%s'" )
                                      ("\\.webm\\'\\|\\.mkv\\'\\|\\.mpe?g\\'\\|\\.avi\\'\\|\\.mp4\\'\\|\\.flv\\'" . "mpv '%s'")
                                      ("\\.d64\\'\\|\\.prg\\'" . "x64sc '%s'")
                                      ("\\.html?\\'" . "firefox '%s'")
...
* EVAL format-all
  ...
  #+begin_src emacs-lisp
    (use-package format-all
      ...
      :ensure t)
  #+end_src
* EVAL compy - adjust programs via patterns (unused)
  ...
  #+begin_src emacs-lisp
    (use-package scratch
      ...
      (defun gb/scratch-insert-comment ()
        ...
        (insert "\n")))
  #+end_src
* EVAL esup - emacs startup profiling (not used)
  #+begin_src emacs-lisp :tangle no
    (use-package esup
      :ensure t
      :commands (esup))
...
#+begin_src emacs-lisp
  (use-package git-related
    :load-path "~/.emacs.d/additionals/")
#+end_src
* EVAL mpvi - control mpv (seek, play, pause ...)
