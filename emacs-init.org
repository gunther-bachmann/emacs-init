    ...
    #+BEGIN_SRC emacs-lisp
      (when (and gb/profile--exwm gb/use-exwm)
        (use-package exwm-config
          ...
          (exwm-input-set-key (kbd "M-s-'") #'gb/exwm-swap-workspace-up)
          (exwm-input-set-key (kbd "C-M-s-'") #'gb/exwm-swap-workspace-up-to-top)
          (exwm-input-set-key (kbd "M-s-/") #'gb/exwm-swap-workspace-down)
          (exwm-input-set-key (kbd "C-M-s-/") #'gb/exwm-swap-workspace-through-to-bottom)
