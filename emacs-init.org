...
*** doom modeline
    ...
    - adjusted file doom-modeline-segments.el:732, changed "block" to "sim_card_alert"
...
** posframe
   ...
   - needed patching posframe.el:492
     #+begin_src emacs-lisp :tangle no
...
* EVAL awscli-capf
  ...
  #+end_src
* EVAL filter annoying messages (disabled)
  #+begin_src emacs-lisp
...
* EVAL emacs-piper (interactively work on os pipe commands)
  ...
  #+begin_src emacs-lisp
    (use-package piper
      :commands piper
      :load-path "/home/pe/.emacs.d/additionals/emacs-piper/")
  #+end_src
