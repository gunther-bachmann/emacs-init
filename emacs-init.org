...
*** org babel
    #+BEGIN_SRC emacs-lisp
      ...
      ;; (add-hook 'after-save-hook 'gb/tangle-on-save-org-mode-file) ;; TODO eval check org-auto-tangle
...
* EVAL - fdupes - find duplicates in dired
  ...
  #+end_src
* EVAL org-auto-tangle - automatically (async) tangle org files on save
  #+begin_src emacs-lisp
