     ...
     (custom-set-variables
      '(safe-local-variable-values
        '((eval gb/set-dictionary "en")
          ...
          (org-tree-slide-presentation-length . 45)
          (org-tree-slide-presentation-length . 60)
          ...
          (with-buffer-modified-unmodified
           (let ((element (org-element-at-point)))
             (when (equal 'src-block (org-element-type element))
               (save-excursion (with-temp-message "fontify src block" (org-fontify-meta-lines-and-blocks-1 (point-max))))))))
