...
* elpa-mirror (see https://github.com/redguardtoo/elpa-mirror)
  #+begin_src emacs-lisp
    ...
    (when (file-exists-p "~/.emacs.d/additionals/elpa-mirror")
      (require 'elpa-mirror))
...
** dired sidebar
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package dired-sidebar
       ...
       (advice-add 'dired-sidebar-toggle-sidebar :after #'(lambda (&rest args) (toggle-truncate-lines '(1))(setq line-spacing 0)))
       ...
       (progn
         ...
         (setq dired-sidebar-width (/ (* 60 (frame-width)) (/ 1920 (default-font-width))))
...
* EVAL embark - provide context sensitive menu
  ...
  #+end_src
* udisksctl - TODO: make package of this
  #+begin_src emacs-lisp
    ...
    (defun gb/udisksctl--completing-read-blk-device ()
      (s-concat "/dev/" (--last (not (string-empty-p it)) (s-split " " (completing-read "Device: " (gb/udisksctl--get-devices) nil t)))))
