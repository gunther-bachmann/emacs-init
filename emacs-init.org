...
** slack
 #+BEGIN_SRC emacs-lisp
   ...
   (use-package slack
     ...
     (defun gb/slack-programming-java ()
       "set slack status"
       (interactive)
       (slack-user-set-status-request (slack-team-select) ":java-coffee:" "programming")
       (gb/slack-user-set-active))
      ...
      (use-package org-tree-slide
        ...
        (defun gb/presentation-start ()
          ...
          (save-excursion
            ...
            (remove-overlays nil (point) 'invisible 'org-hide-block))
