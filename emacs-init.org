      ...
      (progn
        ...
        (defun gb/org-return-dwim ()
          ...
          (let* ((context (org-element-context))
            ...
            (cond ((eq 'link type-at-point)
                   (browse-url (org-element-property :raw-link context)))
                  (t
                   ...
                   (let* ((list-type (car (org-element-at-point)))
                     ...
                     (cond ((and (eq list-type 'headline) (null todo-keyword))
                           ...
                           ((and (string-match "^ *- \\[.*" line) (gb/org-return-dwim--is-list-or-item list-type))
...
** terraform
   #+begin_src emacs-lisp
     ...
     (when (file-exists-p "~/.emacs.d/additionals/terraform-doc.el")
  ...
  #+BEGIN_SRC emacs-lisp
    (when gb/use-exwm
      ...
      (use-package exwm-mff
        :load-path "/home/pe/.emacs.d/additionals/exwm-mff"
        :config
...
* EVAL browse-kill-ring
  #+begin_src emacs-lisp
  (use-package browse-kill-ring
    :load-path "/home/pe/.emacs.d/additionals/browse-kill-ring"
...
* EVAL dianyou (gnus mail searching see https://github.com/redguardtoo/dianyou/blob/master/dianyou.el)
  #+begin_src emacs-lisp
    (use-package dianyou
      :ensure t)
  #+end_src
* INTERESTING isearch-project, gnus-summary-repo, dash-docs, aio, json-reformatter-jq, multi-magit, live-preview, nix-haskell-mode, elpl (emacs lisp repl)
* to test
#+BEGIN_SRC emacs-lisp
...
* EVAL tempbuff mode
  ...
  #+begin_src emacs-lisp
    (when (file-exists-p "~/.emacs.d/additionals/tempbuf.el")
      (use-package tempbuf
        :load-path "~/.emacs.d/additionals/"
        :config (add-hook 'after-change-major-mode-hook 'turn-on-tempbuf-mode)))
  #+end_src
* EVAL hercules
  - see https://gitlab.com/jjzmajic/hercules.el
  - creates hydra like popups derived from which key information
  #+begin_src emacs-lisp
    (when (file-exists-p "~/.emacs.d/additionals/hercules.el/hercules.el")
      (use-package hercules
        :load-path "~/.emacs.d/additionals/hercules.el/"
        :config
        (hercules-def
