      ...
      (setq left-global-mode-string
            (list '((:eval
                  ...
                  '(:eval (or (if (gb/modeline-line-selected-window-active-p)
                                 (get-project-relative-buffer-filename)
                               (substring-no-properties (get-project-relative-buffer-filename)))
  ...
  #+BEGIN_SRC emacs-lisp
    (when (executable-find "direnv")
      (use-package envrc
        ...
        (envrc-none-lighter '(" e[" (:propertize "none" face envrc-mode-line-none-face) "]"))
        :config
        (envrc-global-mode 1)
