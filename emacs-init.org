      ...
      (use-package org
          ...
          (let* ((element (org-element-at-point))
            ...
            (cond
             ...
             (t
              (save-excursion
                (goto-char start)
                (setq parent (org-element-at-point))
        ...
        (defun gb/org-return-dwim ()
          ...
          (let* ((list-type (car (org-element-at-point)))
            ...
            (cond ((eq list-type 'headline)
                   (progn
                     ;; (org-end-of-subtree)
                     (org-insert-heading-after-current)
                     (message "*")))
                  ((and (string-match "^ *- \\[.*" line) (or (eq list-type 'item) (eq list-type 'plain-list)))
                   (progn
                     ;;(org-end-of-line)
                     (org-end-of-item)
                  ...
                  ((and (string-match "^ *- [^\\[].*" line) (or (eq list-type 'item) (eq list-type 'plain-list)))
                   (progn
                     ...
                     (if (not (org-in-item-p))
                       ...
                       (org-meta-return))
                     (message "-")))
                  (t (progn (org-end-of-line)(org-return-indent) (message "return")))))
          )
