...
* TODO dired-annotator - make package of this
  #+begin_src emacs-lisp
    ...
    (defun dired-annotator--hash (file-name hash-type)
    ...
    (defun dired-annotator-delete-note ()
      ...
      (when-let* ((annotated-file-name (dired-get-filename))
        ...
        (when (yes-or-no-p "Really delete this annotation? ")
          ...
          (dired-annotator--unhash-file (dired-annotator--hash annotated-file-name) annotated-file-name)
    ...
    ;; - BUG: make sure that folding subdirs does not leave note overlays
