    ...
    - audio functions
       #+begin_src emacs-lisp
         ...
         (defun gb/audio-output-select ()
           "select audio output "
           (interactive)
           (let ((sink-name (ivy-read "audio-output:" (gb/audio-outputs-available) :require-match t)))
         ...
         (defun gb/audio-input-select ()
           "select audio input"
           (interactive)
           (let ((source-name (ivy-read "audio-input:" (gb/audio-input-available) :require-match t)))
