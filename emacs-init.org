...
* TODO video streamlining
  #+begin_src emacs-lisp
    ...
    (defun gb/video-modeline ()
      ...
      (if gb-typing-muted-mic
          (propertize " 𝚺" 'font-lock-face  '(:foreground "#822"))
        (propertize " 𝚺" 'font-lock-face  '(:foreground "#282"))))
    ...
    (defun gb/on-typing ()
      ...
      (setq gb-typing-timer (run-with-timer 1 nil  #'gb/unmute-since-no-typing)))
