...
* package setup
  #+BEGIN_SRC emacs-lisp
    ...
    (defun gb/update-myelpa-packages ()
      "create update of current package status to repo/myelpa"
      (interactive)
    ...
    (setq package-to-install-initially
          '( dash
             ...
             ;; key-chord
             validate
             ;; use-package ;; already part of emacs now
             seq
    ...
    ;; allows use-package to make use of :vc
...
** allowed dir locals
   ...
   #+begin_src emacs-lisp
     ...
     (put 'org-tree-slide-center-headers 'safe-local-variable 'booleanp)
...
** other
   #+BEGIN_SRC emacs-lisp
     ...
     (defun gb/banish-mouse ()
  
       (if exwm-window-type
           (let ((edges (window-edges)))
             (set-mouse-position (selected-frame) (+ (car edges) (/ (window-width) 2)) (+ (cadr edges) (/ (window-height) 2))))
         (set-mouse-position (selected-frame) (- (frame-width (selected-frame)) 2) 0)))

     (add-hook 'window-configuration-change-hook #'gb/banish-mouse)
     (add-hook 'window-state-change-hook #'gb/banish-mouse)
...
** editing
   #+BEGIN_SRC emacs-lisp
     ...
     ;; don't Highlight current line by default
     (global-hl-line-mode -1)
     (defun gb/disable-hl-line-mode-locally ()
       (setq-local global-hl-line-mode nil)
       (setq-local hl-line-mode nil))

     (add-hook 'term-mode-hook #'gb/disable-hl-line-mode-locally)
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package expand-region
        ...
        :bind (("C-x <up>" . er/expand-region)
               ...
               :map org-mode-map
               ("C-x <up>" . gb/expand-in-large-org-mode-files)
               ("C-x <C-up>" . gb/expand-in-large-org-mode-files))
        ...
        (defun gb/expand-in-large-org-mode-files ()
          (interactive)
...
** keyfreq
   #+BEGIN_SRC emacs-lisp
     (use-package keyfreq
       ...
       :config
       (progn
         (setq keyfreq-autosave-timeout 2400)
         (keyfreq-mode 1)
     ...
     (use-package company-box
       ...
       (progn
         ...
         (defun company-box-doc--show-after-advice--serif-on (&rest args)
           ...
           (when (and (frame-local-getq company-box-doc-frame)
                    (frame-visible-p (frame-local-getq company-box-doc-frame)))
     ...
     (use-package recentf
       ...
       (progn
         ...
         (let ((rsf-size-str (s-trim (safe-shell-command-to-string (s-concat "ls -la " recentf-save-file " | awk '{ print $5; }'")))))
           (if (<= 50000 (string-to-number rsf-size-str))
               (progn
         ...
         ;; copied from https://www.emacswiki.org/emacs/recentf-ext.el
     ...
     (when (eq gb/completion-framework 'ivy)
       ...
       (use-package counsel
         ...
         :bind (( "M-x"     . counsel-M-x)
                ...
                ( "C-c g i" . counsel-rg)
                ( "C-x d d"   . counsel-dired)
                ( "C-x d r"   . counsel-goto-recent-directory)
         ...
         (progn
            ;; copied from https://blog.binchen.org/posts/use-ivy-to-open-recent-directories.html
                     ...
                     (delete-dups
                      (append (mapcar 'file-name-directory recentf-list)
                              ...
                              (when (executable-find "fasd")
                                  (split-string (safe-shell-command-to-string "fasd -ld") "\n" t))))))
...
*** org
  #+BEGIN_SRC emacs-lisp
    (use-package org
      ...
      (org-pretty-entities t     "prettify \\lambda and other slash specs")
      :init
      ...
      (with-eval-after-load 'org
        ...
        ;; org-crypt magic (was disabled, since it has trouble with gpg 2.4.1 (fixed with 2.4.4)    
        (require 'org-crypt)
...
** helm extensions
   ...
   #+END_SRC
* vagrant docker ansible (disabled)
** docker (disabled)
...
#+BEGIN_SRC emacs-lisp
    (use-package helm-backup
      ...
      :vc (helm-backup :url "https://github.com/gunther-bachmann/helm-backup"
                       :branch "main")
...
** configuration
   #+BEGIN_SRC emacs-lisp
     (use-package dired
       ...
       :config
       (setq large-file-warning-threshold 250000000)
       ...
       (setq dired-guess-shell-alist-user '(
                                            ("\\.webm\\'\\|\\.mkv\\'\\|\\.mpe?g\\'\\|\\.avi\\'\\|\\.mov\\'\\|\\.wmv\\'\\|\\.mp4\\'\\|\\.flv\\'" "mpv")
                                            ("\\.d64\\'\\|\\.prg\\'" "x64sc")
                                            ("\\.sid\\'" "sidplayfp")
                                            ("\\.html?\\'" "firefox")
...
** dired-annotator
   #+begin_src emacs-lisp
     ...
     (use-package dired-annotator
       ...
       :vc (dired-annotator :url "https://github.com/gunther-bachmann/emacs-dired-annotator"
                            :branch "main")    
...
#+begin_src emacs-lisp
  (use-package doc-base
    ...
    :vc (emacs-doc-base :url "https://github.com/gunther-bachmann/emacs-doc-base"
                        :branch "main")    
...
** buffer-expose - switch buffer expose
   #+begin_src emacs-lisp
     ...
     (use-package buffer-expose
       ...
       :vc (buffer-expose :url "https://github.com/clemera/buffer-expose"
                          :branch "master")
  ...
  - package
    #+begin_src emacs-lisp
      (use-package org-tree-slide
        ...
        :vc (org-tree-slide :url "https://github.com/gunther-bachmann/org-tree-slide"
                            :branch "merged-master-branch")    
        ...
        (defun gb/presentation-on ()
          ...
          (interactive)
          (unless (version< "9.6.23" org-version)
          ...
          (setq org-show-notification-handler
                #'(lambda
                    ...
                    (message msg)))
          (mlscroll-mode 0)
          (unless (boundp 'global-linum-mode)
  ...
  #+begin_src emacs-lisp
    ...
    (if (version< emacs-version "29")
      ...
      (progn
        ...
        (setq eglot-report-progress t)           ;; report progress
        ;; (fset #'jsonrpc--log-event #'ignore)  ;; disable logging output 
        ;; (setq eglot-events-buffer-size 0)     ;; reduce events logging
        ;; (setq eglot-send-changes-idle-time 1) ;; report changes to language server after idle time
        ))
  #+end_src
* vue (via lsp - eglot, thus this must be defined after eglot)
  - see https://genehack.blog/2020/08/web-mode-eglot-vetur-vuejs-=-happy/
  - alternatively look at https://github.com/joaotavora/eglot/discussions/1184
  - install vls via ~npm install -g vls~
  #+begin_src emacs-lisp
    (setq gb/use-vue-volar t)
    (setq gb/use-vue-vls (not gb/use-vue-volar))

    (when (and gb/use-vue-vls (package-installed-p 'eglot) (package-installed-p 'web-mode) (executable-find "vls"))
      ;; does not resolve references to properties in template (which volar does)
      (require 'web-mode)
      (require 'eglot)
    ...
    (when (and gb/use-vue-volar (package-installed-p 'eglot) (package-installed-p 'web-mode) (executable-find "vue-language-server"))
      ;; nix-env -iA nixos.nodePackages.typescript-language-server
      ;; nix-env -iA nixos.nodePackages.volar
      ;; example project: npm create vite@latest my-vue-app -- --template vue
      (require 'web-mode)
      (require 'eglot)
      (define-derived-mode gb/vue-mode web-mode "gbVue"
        "A major mode derived from web-mode, for editing .vue files with LSP support.")
      ...
      (add-to-list 'eglot-server-programs 
                   `(gb/vue-mode . ("vue-language-server" "--stdio" :initializationOptions ,(vue-eglot-init-options)))))
  #+end_src
...
* winum (select windows by number, which is shown in the modeline)
  ...
  #+begin_src emacs-lisp
    (use-package winum
      :ensure t
      :custom (winum-auto-setup-mode-line nil "display number of window in the modeline")
...
* EVAL emacs surround (see [[https://github.com/ganmacs/emacs-surround][here]])
  #+begin_src emacs-lisp
    ...
    (use-package emacs-surround
      ...
      :vc (emacs-surround :url "https://github.com/ganmacs/emacs-surround"
                          :branch "master")    
...
* EVAL browse-kill-ring
  #+begin_src emacs-lisp
    (use-package browse-kill-ring
      ...
      :vc (browse-kill-ring :url "https://github.com/T-J-Teru/browse-kill-ring"
                            :branch "master")    
...
* EVAL emacs-piper (interactively work on os pipe commands)
  ...
  #+begin_src emacs-lisp
    (use-package piper
      ...
      :commands piper
      :vc (emacs-piper :url "https://gitlab.com/howardabrams/emacs-piper"
                       :branch "main"))
  #+end_src
  ...
  #+begin_src emacs-lisp
    (when gb/profile--org-roam
      (use-package notdeft
        ...
        ;; :vc (notdeft :url "https://github.com/gunther-bachmann/notdeft"
        ;;              :branch "xapian")    
...
** org-roam-stack
  #+begin_src emacs-lisp
    ...
    (use-package org-roam-stack
      ...
      :vc (org-roam-stack :url "https://github.com/gunther-bachmann/org-roam-stack"
                          :branch "main")    
  ...
  #+begin_src emacs-lisp
    (when (eq gb/use-frame-completion 'mini-frame)
      (use-package mini-frame
        ...
        :vc (emacs-mini-frame :url "https://github.com/gunther-bachmann/emacs-mini-frame"
                              :branch "master")
...
* share2computer
  ...
  #+end_src
* DISABLED bufler (not really used)
...
* EVAL org-padding - define padding for each org mode heading level
  #+begin_src emacs-lisp
    ...
    (use-package org-padding
      ;; :load-path "~/.emacs.d/additionals/"
      :vc (org-padding :url "https://github.com/TonCherAmi/org-padding"
                       :branch "master")    
      :config
...
* EVAL regexp-expand - show regular expression at point expanded
  ...
  #+begin_src emacs-lisp
    ...
    (use-package regexp-expand
      ...
      :vc (regexp-expand :url "https://github.com/danielmartin/regexp-expand"
                         :branch "master")    
...
* valign - better table alignment in org-mode and markdown
  ...
  #+begin_src emacs-lisp
    (use-package valign
      ...
      :vc (valign :url "https://github.com/casouri/valign"
                  :branch "master")    
...
* org-tree-slide-pause
  #+begin_src emacs-lisp
    (use-package org-tree-slide-pauses
      ...
      :vc (org-tree-slide-pauses :url "https://github.com/gunther-bachmann/org-tree-slide-pauses"
                                 :branch "main")
      :after (bind-key)
...
* tree-sitter
  ...
  #+begin_src emacs-lisp
    ...
    (use-package ts-fold
      ...
      :vc (ts-fold :url "https://github.com/emacs-tree-sitter/ts-fold"
                   :branch "master")    
...
* EVAL ltex
  ...
  #+begin_src emacs-lisp
    ...
    (use-package eglot-ltex
      ...
      :vc (eglot-ltex :url "https://github.com/emacs-languagetool/eglot-ltex"
                      :branch "master")    
...
#+begin_src emacs-lisp
  ...
  (defconst llama-model-short "codellama")
  (defconst llama-model-long "codellama:latest")
...
#+end_src
* EVAL org-sliced-images (decativated)
- cool but does introduce space between lines if line-spacing is not 0!
#+begin_src emacs-lisp :tangle no
...
#+end_src
* elisa (disarded)
- additionally needed an sql lite extension (sqlite-vss) to be installed as binary
#+begin_src emacs-lisp :tangle no
  (use-package elisa
    :vc (elisa :url "https://github.com/s-kostyaev/elisa"
               :branch "main"))
#+end_src
...
* finish - up
  #+BEGIN_SRC emacs-lisp
    ...
    (gb/net-connect-default)
    (if (gb/net-adapter-up-p gb/net-lan-adapter)
        (gb/screensaver-disable)
