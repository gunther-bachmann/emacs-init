  ...
  #+begin_src emacs-lisp
    (eval-when-compile
      (defun gb/maxima-elisp-loadpath ()
        (cond ((or running-nixos (string-match-p "guix-profile" (executable-find "maxima")))
...
* TODO backup duplicity support - make package
  #+begin_src emacs-lisp
    ...
    (defun gb/backup-mount ()
      "get the mount into which a backup is usually writing"
      "684110cc-325f-4307-bce0-843930ff7de6")
  #+end_src
