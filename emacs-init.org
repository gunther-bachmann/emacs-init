...
* TODO dired-annotator - make package of this
  #+begin_src emacs-lisp
    ...
    (defvar dired-annotator-annotations-folder (expand-file-name "~/documents/annotations") "location for annotation files")
    ...
    (when (package-installed-p 'dired-subtree)
      (report-elapsed "check-point - dired-annotator: dired subtree integration")
