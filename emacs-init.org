...
** font related stuff
   #+BEGIN_SRC emacs-lisp
     ...
     (setq jit-lock-defer-contextually nil ;; t ;; 'syntax-driven
           jit-lock-context-time 0.1 ;; 0.2
           jit-lock-defer-time 0.1 ;; 0.2
           jit-lock-stealth-load 200 ;; 200
           jit-lock-stealth-nice 0.1 ;; 0.2
           jit-lock-stealth-time 0.1 ;; 0.2
...
** slack
 #+BEGIN_SRC emacs-lisp
   ...
   ;; patch on slack-20200830.1021
   ;; file slack-block.el:53
   ;; inore errors in creating layout block
   ;;     (defun slack-create-layout-block (payload)
   ;;       (ignore-errors ;; <- GBA ADDED
