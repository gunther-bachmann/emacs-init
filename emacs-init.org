                       ...
                       (if dual-monitor
                           (let* ((second-monitor (gb/get-second-monitor)))
                             ...
                             (if (string-empty-p second-monitor)
                                 (setq exwm-randr-workspace-monitor-plist `(0 ,primary-monitor 1 ,primary-monitor 2 ,primary-monitor 3 ,primary-monitor))
                               (progn
                                 (message "dual monitor")
                                 (setq  exwm-randr-workspace-monitor-plist `(0 ,primary-monitor 1 ,second-monitor 2 ,second-monitor 3 ,second-monitor)) ;; 0 "DP-2"
