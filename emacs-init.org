     ...
     (use-package paradox
       ...
       :init
         (progn
           ...
           ;; TODO jde read properties is not known yet
           (defun gb/paradox-list-packages (nofetch)
             "make sure to load github token when using paradox list packages"
             (interactive "P")
...
** display symbols (pretty-mode, prettify-greek)
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package prettify-greek) ;; prettify greek symbols
   #+END_SRC
** font related stuff
   #+BEGIN_SRC emacs-lisp
  ...
  #+BEGIN_SRC emacs-lisp
    (when gb/use-exwm
      ...
      (use-package exwm-config
        :after ( exwm helm-external helm-mode)
        :config
        (exwm-config-default)
