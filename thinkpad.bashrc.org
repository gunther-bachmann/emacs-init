...
* alias
  #+begin_src sh :eval no :tangle ~/.bashrc
    ...
    alias wlan-restart="TERM=dumb sudo systemctl restart wpa_supplicant-wlp4s0.service"
    alias wlan-status="TERM=dumb sudo systemctl status wpa_supplicant-wlp4s0.service -l"
    alias wlan-term="TERM=dumb sudo systemctl stop wpa_supplicant-wlp4s0.service"
