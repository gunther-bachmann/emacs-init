...
* default bar
  #+begin_src conf :eval no :tangle ~/.config/polybar/config
    ...
    ; modules-center = date
    modules-right = github backup memory cpu temperature system-fan-speed cpu-clock vpn-service wired-network wireless-network power-consumption battery
