...
* battery
  #+begin_src conf :eval no :tangle ~/.config/polybar/config
    ...
    ;   <ramp-capacity>
    ;   <animation-charging>
    format-charging = <ramp-capacity> %{F#822}<label-charging>
    ...
    ramp-capacity-0 = %{F#ff0}▁
    ramp-capacity-1 = %{F#ff0}▂
    ramp-capacity-2 = %{F#880}▃
    ramp-capacity-3 = ▄
    ramp-capacity-4 = ▅
    ramp-capacity-5 = ▆
    ramp-capacity-6 = %{F#282}▇
    ramp-capacity-7 = %{F#282}█
    ; ramp-capacity-0 = 
    ; ramp-capacity-1 = 
    ; ramp-capacity-2 = 
    ; ramp-capacity-3 = 
